...
Analiz envanterine (docs/_calisma-arsivi/analiz-tam.json) göre tarih/doğruluk düzeltme listesi. (README 72/72-97/97 çelişkisi gibi salt teknik/metin hataları teknik planın işidir; burada yalnız tarihsel doğruluk kalemleri var.)
