...
| H6 | Komşuluk ve merhamet | Müslim, Îmân (komşusu açken tok yatan) | Kuraklık/kıtlık olayları, iftar sofrası |
...
- **Tetik:** Yılda bir (havl temsili), hasat mevsimi girişinde (`GameState.advanceSeason`, `GameState.js:257-269`, `seasonIndex===2` Güz'e geçişte) kethüda bir arzuhal-üstü hatırlatma getirir: "Beyim, kazancının hesabını yap; nisâba mâlik olan zekâtını verir." Bildirim + Tımar Defteri'nde `Zekât Ver` eylemi görünür.
...
- [ ] **Z1:** Güz'e geçişte zekât hatırlatması bir kez düşer; `akce=2500` iken `Zekât Ver` 50 akçe düşürür (2500−500=2000×0.025); `akce=400` iken eylem görünmez (nisâb altı).
...
- [ ] **R1:** 68. gün HUD'da "H. 798 Ramazan 1" görünür; 98. günde "Şevval 1" + bayram rozeti.
- [ ] **R2:** Ramazan'da 12:50-14:00 penceresinde han önünde EATING durumunda NPC yoktur; 18:05'te ≥8 NPC sofradadır.
- [ ] **R3:** Bayram günlerinde 09:00-18:00 arası WORKING durumunda `regular` NPC yoktur.
...
**K2 — Abdest (A)**
"Abdest, namaza hazırlık için elleri, yüzü, kolları yıkamak ve başı mesh edip ayakları yıkamaktan ibaret bir temizliktir; 'mü'minin silahı ve nurudur' denilmiştir. Mescidlerin avlusundaki şadırvanlar bunun içindir: cemaat namazdan önce burada abdest alır. Osmanlı çarşısında hamamın, çeşmenin ve şadırvanın bolluğu, temizliği ibadetin parçası sayan bu anlayışın eseridir."
